...
* currencies (название, трёхбуквенное обозначение, индекс?)
...
* Возможность докидывать и удалять категории, выбор категории кнопкой при создании записи. При удалении нужно выбрать категорию - преемника. ОЧ ОПАСНАЯ ОПЕРАЦИЯ, ТОЛЬКО СУПЕРАДМИНАМ
